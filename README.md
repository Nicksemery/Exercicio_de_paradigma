...
O segundo ponto foi a verbosidade em java deixou o código maior, apesar de usar menos while. Porem, ao optar por orientado a objetos, as funções ficaram bem mais organizadas dentro da classe molde "Tarefas", permitindo a limpeza visual dentro da main. Diferente de python, que cada ação tem uma reação sem precisar instanciar um objeto e suas funções.
No fim, o exercicio deixa bem claro as diferenças entre linguaguens e métodos abordados, mesmo o programa tendo as mesmas funcionalidades.
